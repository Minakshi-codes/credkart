    ...
    def test_UserRegistration_001(self, setup):
        ...
        if self.ur.Validate_Login_Or_Registration() == "Login or Registration Pass":
            ...
            self.driver.save_screenshot(
                "C:\\Users\\Lenovo\\Documents\\Python Revision Notes\\selenium\\selenium practical\\Pytest_Credkart - Copy\\Screenshots\\Registration_Pass.png")
            # self.driver.close()
            assert True
        else:
            self.log.info("test_UserRegistration_001 is fail")
            self.driver.save_screenshot(
                "C:\\Users\\Lenovo\\Documents\\Python Revision Notes\\selenium\\selenium practical\\Pytest_Credkart - Copy\\Screenshots\\Registration_Fail.png")
            # self.driver.close()
            # self.driver.close()
            assert False
