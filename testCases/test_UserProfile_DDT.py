...
class Test_User_Profile_DDT:
    ...
    path = "C:\\Users\\Lenovo\\Documents\\Python Revision Notes\\selenium\\selenium practical\\Pytest_Credkart - Copy\\testCases\\TestData\\LoginData.xlsx"
...
# "pytest -v -s -m sanity --html=HTMLReports/Edge_Report.html --browser chrome -n=5 --alluredir="C:\Users\HP\Desktop\Python revision Jan 24\Pytest_Credkart\AllureReports
#  pytest  -m sanity
#
