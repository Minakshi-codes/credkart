    ...
    def test_UserLogin_Params_005(self, setup, getDataForLogin):
        ...
        if self.ur.Validate_Login_Or_Registration() == "Login or Registration Pass":
            if getDataForLogin[2] == "Pass":
                self.driver.save_screenshot(
                    "C:\\Users\\Lenovo\\Documents\\Python Revision Notes\\selenium\\selenium practical\\Pytest_Credkart - Copy\\Screenshots\\Login_Pass.png")
            ...
            self.driver.save_screenshot(
                "C:\\Users\\Lenovo\\Documents\\Python Revision Notes\\selenium\\selenium practical\\Pytest_Credkart - Copy\\Screenshots\\Login_Fail.png")
...
# pytest -v --html=HTMLReports/Edge_Report.html --browser chrome -n=3 --alluredir="C:\\Users\\Lenovo\\Documents\\Python Revision Notes\\selenium\\selenium practical\\Pytest_Credkart - Copy\\AllureReports"
# pytest -v --browser chrome -n=3 --alluredir="C:\\Users\\Lenovo\\Documents\\Python Revision Notes\\selenium\\selenium practical\\Pytest_Credkart - Copy\\AllureReports"
#
#pytest -v  --alluredir = "C:\Users\Lenovo\Documents\Python Revision Notes\selenium\selenium practical\Pytest_Credkart - Copy\allure-report"
...
# pytest -v "C:\\Users\\Lenovo\\Documents\\Python Revision Notes\\selenium\\selenium practical\\Pytest_Credkart - Copy\\testCases" --html=HTMLReports//Edge_Report.html --alluredir ="C:\\Users\\Lenovo\\Documents\\Python Revision Notes\\selenium\\selenium practical\\Pytest_Credkart - Copy\\AllureReports"